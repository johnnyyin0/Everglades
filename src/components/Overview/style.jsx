const Style = ({style, setPhoto, setSelectedStyle, styleSelected, createSkusArray}) => {
  ...
  return (
    <>
    {style == styleSelected ?
    <img src={style.photos[0].thumbnail_url} className="object-fill h-[70px] w-[70px] rounded-full ml-4 border-4 border-blue-600 hover:scale-105 ease-in-out duration-300"></img>
