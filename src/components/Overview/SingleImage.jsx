const SingleImage = ({image, setPhoto, photo, i, setIndex, index}) => {
  ...
  return (
    <div className="">
      ...
      <img src={image.thumbnail_url} onClick={(e) => imageClick()} className=" object-fill h-[60px] w-[60px] rounded-full mr-2 mb-2 ml-2 border-4 border-blue-600 hover:scale-105 ease-in-out duration-300"></img>
